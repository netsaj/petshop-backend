	...
	translations := []struct {
		...
		},
		{
			...
			customRegisFunc: func(ut ut.Translator) (err error) {
				...
				if err = ut.Add("len-string", "{0} debe tener {1} en longitud", false); err != nil {
					return
				}
			...
			END:
				if err != nil {
					fmt.Printf("Peligro: Error traduciendo validación: %s", err)
		...
		},
		{
			...
			customRegisFunc: func(ut ut.Translator) (err error) {
				...
				if err = ut.Add("min-number", "{0} deber ser {1} o mayor", false); err != nil {
					return
				}
		...
		},
		{
			...
			customRegisFunc: func(ut ut.Translator) (err error) {
				...
				if err = ut.Add("max-string", "{0} debe tener un máximo de {1} en longitud", false); err != nil {
					return
				}
				...
				if err = ut.Add("max-items", "{0} debe contener un máximo de  {1}", false); err != nil {
					return
				}
		...
		},
		{
			...
			customTransFunc: func(ut ut.Translator, fe validator.FieldError) string {
				...
				if err != nil {
					fmt.Printf("Peligro: Error traduciendo validación: %#v", fe)
					return fe.(error).Error()
				}
		...
		{
			tag:         "ne",
			translation: "{0} no debe ser igual a {1}",
			override:    false,
			customTransFunc: func(ut ut.Translator, fe validator.FieldError) string {
		...
		},
		{
			...
			customRegisFunc: func(ut ut.Translator) (err error) {
				...
				if err = ut.Add("lt-string", "{0} debe ser menor que {1} en longitud", false); err != nil {
					return
				}
				...
				if err = ut.Add("lt-number", "{0} debe ser menor que {1}", false); err != nil {
					return
				}
				...
				if err = ut.Add("lt-datetime", "{0} debe ser menor que la fecha y hora actual", false); err != nil {
					return
				}
			...
			customTransFunc: func(ut ut.Translator, fe validator.FieldError) string {
				...
				case reflect.Struct:
					if fe.Type() != reflect.TypeOf(time.Time{}) {
						err = fmt.Errorf("tag '%s' no puede ser usado en un tipo struct", fe.Tag())
						goto END
					}
		...
		},
		{
			...
			customRegisFunc: func(ut ut.Translator) (err error) {
				...
				if err = ut.Add("lte-string", "{0} debe tener un máximo de {1} en longitud", false); err != nil {
					return
				}
				...
				if err = ut.Add("lte-datetime", "{0} debe ser menor que o igual a la fecha y hora actual", false); err != nil {
					return
				}
		...
		},
		{
			...
			customRegisFunc: func(ut ut.Translator) (err error) {
				...
				if err = ut.Add("gt-datetime", "{0} debe ser mayor que la fecha y hora actual", false); err != nil {
					return
				}
		...
		},
		{
			...
			customRegisFunc: func(ut ut.Translator) (err error) {
				...
				if err = ut.Add("gte-string", "{0} debe ser por lo menos {1} en longitud", false); err != nil {
					return
				}

				if err = ut.AddCardinal("gte-string-character", "{0} caracter", locales.PluralRuleOne, false); err != nil {
					return
				}
				...
				if err = ut.Add("gte-number", "{0} debe ser {1} o superior", false); err != nil {
					return
				}
				...
				if err = ut.Add("gte-datetime", "{0} debe ser mayor que o igual a la fecha y hora actual", false); err != nil {
					return
				}
		...
		},
		{
			...
			customTransFunc: func(ut ut.Translator, fe validator.FieldError) string {
				...
				t, err := ut.T(fe.Tag(), fe.Field(), fe.Param())
				if err != nil {
					log.Printf("Peligro: Error traduciendo validación: %#v", fe)
					return fe.(error).Error()
				}
		...
		{
			tag:         "gtecsfield",
			translation: "{0} debe ser mayor que o igual a {1}",
			override:    false,
			customTransFunc: func(ut ut.Translator, fe validator.FieldError) string {
		...
		{
			tag:         "ltecsfield",
			translation: "{0} debe ser menor que o igual a {1}",
			override:    false,
			customTransFunc: func(ut ut.Translator, fe validator.FieldError) string {
		...
		{
			tag:         "alpha",
			translation: "{0} solo puede contener letras",
			override:    false,
		},
		{
			tag:         "alphanum",
			translation: "{0} solo puede contener números y letras",
			override:    false,
		},
		{
			tag:         "numeric",
		...
		{
			tag:         "hexadecimal",
			translation: "{0} debe ser un valor hexadecimal",
			override:    false,
		},
		{
			tag:         "hexcolor",
			translation: "{0} debe ser un color hexadecimal válido",
			override:    false,
		},
		{
			tag:         "rgb",
		...
		{
			tag:         "rgba",
			translation: "{0} debe ser in color RGBA válido",
			override:    false,
		},
		{
			tag:         "hsl",
		...
		{
			tag:         "hsla",
			translation: "{0} debe ser un color HSLA válido",
			override:    false,
		},
		{
			tag:         "email",
			translation: "{0} debe ser una dirección de correo electrónico valida",
			override:    false,
		},
		{
			tag:         "url",
			translation: "{0} debe ser una URL valida",
			override:    false,
		},
		{
			tag:         "uri",
			translation: "{0} debe ser una URI valida",
			override:    false,
		},
		{
			tag:         "base64",
			translation: "{0} debe ser un texto en Base64 válido",
			override:    false,
		},
		{
			tag:         "contains",
		...
		{
			tag:         "excludes",
			translation: "{0} cno pude contener el texto '{1}'",
			override:    false,
			customTransFunc: func(ut ut.Translator, fe validator.FieldError) string {
		...
		{
			tag:         "uuid3",
			translation: "{0} debe ser un UUID v3 válido",
			override:    false,
		},
		{
			tag:         "uuid4",
			translation: "{0} debe ser un UUID v4 válido",
			override:    false,
		},
		{
			tag:         "uuid5",
			translation: "{0} debe ser un UUID v5 válido",
			override:    false,
		},
		{
			tag:         "ascii",
			translation: "{0} debe contener solo caracteres ascii",
			override:    false,
		},
		{
			tag:         "printascii",
			translation: "{0} debe contener solo caracteres ascii imprimibles",
			override:    false,
		},
		{
			tag:         "multibyte",
		...
		{
			tag:         "longitude",
			translation: "{0} debe contener coordenadas de longitud válidas",
			override:    false,
		},
		{
			tag:         "ssn",
			translation: "{0} debe ser un número SSN válido",
			override:    false,
		},
		{
			tag:         "ipv4",
		...
		{
			tag:         "cidr",
			translation: "{0} debe contener una notación CIDR válida",
			override:    false,
		},
		{
			tag:         "cidrv4",
		...
		{
			tag:         "cidrv6",
			translation: "{0} debe contener una notación CIDR válida para una dirección IPv6s",
			override:    false,
		},
		{
			tag:         "tcp_addr",
		...
		{
			tag:         "tcp4_addr",
			translation: "{0} debe ser una dirección TCP IPv4 válida",
			override:    false,
		},
		{
			tag:         "tcp6_addr",
			translation: "{0} debe ser una dirección TCP IPv6 válida",
			override:    false,
		},
		{
			tag:         "udp_addr",
		...
		{
			tag:         "udp4_addr",
			translation: "{0} debe ser una dirección UDP IPv4 válida",
			override:    false,
		},
		{
			tag:         "udp6_addr",
			translation: "{0} debe ser una dirección UDP IPv6 válida",
			override:    false,
		},
		{
			tag:         "ip_addr",
